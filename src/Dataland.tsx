...
function Dataland() {	
	...
	useEffect(() => {
		...
		setIsLoading(true)
		// Promise.all([axios.get(`https://swift-api.fly.dev/getSongs`), axios.get(`http://localhost:3000/getSpotifyPlays`), axios.get(`https://swift-api.fly.dev/getLyricStats`)])
		// .then(([r1, r2, r3])=> {
		// 	songsFullDB = r1.data.songList
			
		// 	spotify_full_data = r2.data.spotify_plays
		// 	setSpotifyData(spotify_full_data)

		// 	lyricStats = r3.data.lyricStats
